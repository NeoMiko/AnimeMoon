      ...
      <div class="center-block rejestracja">
        <form class="form-horizontal" action="login_p.php" method="post" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="email" class="form-control" id="inputEmail" required autocomplete="off" name="email" placeholder="Haku_@animemoon.com">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" class="btn btn-success" name="login">Zaloguj mnię</button>
            </div>
          </div>
        </form>
      </div>
